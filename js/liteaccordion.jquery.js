...
; (function ($) {
    ...
    var LiteAccordion = function (elem, options) {
        ...
        // 'globals'
            ...
            pageArray = ["Home", "BAE", "BAT",/* "BAA",*/ "Resume"],
            fadein = true,
        ...
        // core utility and animation methods
            core = {
                ...
                triggerSlide: function (e) {
                    ...
                    // animate and load html page
                    var pageIndex = tab.index;
                    if ($this.hasClass('selected') && $this.position().left < slideWidth / 2) {
                        // animate single selected tab
                        core.animSlide.call(tab);
                        
                        for (var i = 0; i < header.length; i++) {
                            $("div#" + pageArray[i] + "page").fadeOut('slow');
                        }
                        if (pageIndex == 0) { pageIndex = 1;}
                        if (fadein) {
                            fadein = false;
                            $("div#" + pageArray[pageIndex - 1] + "page").delay(600).fadeIn('slow', function () { fadein = true });
                        }
                        else {
                            $("div#" + pageArray[pageIndex - 1] + "page").delay(1500).fadeIn('slow', function () { fadein = true });
                        }
                        ...
                        if (fadein) {
                            fadein = false;
                            $("div#" + pageArray[pageIndex] + "page").delay(600).fadeIn('slow', function () { fadein = true });
                        }
                        else {
                            $("div#" + pageArray[pageIndex] + "page").delay(1500).fadeIn('slow', function () { fadein = true });
                        }
                    }
